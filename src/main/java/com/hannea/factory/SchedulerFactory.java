...
public class SchedulerFactory {
    ...
    public static Scheduler scheduler = SpringUtils.getBean("schedulerFactoryBean");
    ...
    public static List<ScheduleJob> getAllJob() {
        ...
        try {
            ...
            throw new RuntimeException("获取所有定时任务失败");
        }
        return jobList;
    }
    ...
    public static List<ScheduleJob> getRunningJob(){
        try{
            ...
            throw new RuntimeException("获取所有正在运行的任务失败");
        }
    }
    ...
    public synchronized static void add(ScheduleJob scheduleJob, boolean start){
        ...
        //组合名称（定时器名称+分组名称）
        TriggerKey triggerKey = TriggerKey.triggerKey(String.valueOf(scheduleJob.getScheduleJobId()), String.valueOf(scheduleJob.getScheduleJobGroupId()));
    ...
    public static void unscheduleJob(ScheduleJob scheduleJob){
        try {
            TriggerKey triggerKey = TriggerKey.triggerKey(String.valueOf(scheduleJob.getScheduleJobId()), String.valueOf(scheduleJob.getScheduleJobGroupId()));
    ...
    public void runAJobNow(ScheduleJob scheduleJob){
        try{
            ...
            throw new RuntimeException("立即执行任务失败.");
        }
    }
